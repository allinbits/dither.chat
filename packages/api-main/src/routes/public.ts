...
export const publicRoutes = new Elysia()
  ...
  .get('/feed', GetRequests.GlobalFeed, { query: Gets.FeedQuerySchema })
  .get('/feed/:slug', GetRequests.FeedBySlug)
  .get('/feeds', GetRequests.ListFeeds)
  ...
  .get('/following-posts', GetRequests.FollowingFeed, { query: Gets.PostsQuerySchema })
